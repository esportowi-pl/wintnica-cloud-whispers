...
const WidgetPanel2: React.FC<WidgetPanel2Props> = ({ onClose, style }) => {
  return (
    <div 
      className="fixed top-0 right-0 w-80 h-full shadow-2xl z-50 overflow-hidden flex flex-col"
      style={{
        ...style,
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-br from-green-500/30 to-emerald-500/30 border border-green-400/30">
            ...
            <div className="space-y-3">
              <div className="border-l-2 border-green-400 pl-3">
                ...
                <div className="text-white/70 text-xs line-clamp-2">Rozpoczęła się budowa nowego parku rekreacyjnego w centrum miasta...</div>
              </div>
              <div className="border-l-2 border-blue-400 pl-3">
                <div className="text-white text-sm font-medium mb-1">Festiwal Letni 2024</div>
                <div className="text-white/70 text-xs line-clamp-2">Już wkrótce wielki festiwal muzyczny w centrum miasta...</div>
              </div>
              <div className="border-l-2 border-yellow-400 pl-3">
                <div className="text-white text-sm font-medium mb-1">Nowe miejsce parkingowe</div>
                <div className="text-white/70 text-xs line-clamp-2">Otwarto dodatkowe miejsca parkingowe przy rynku...</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-br from-orange-500/30 to-red-500/30 border border-orange-400/30">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="w-full bg-white/20 rounded-full h-2">
                  <div className="bg-gradient-to-r from-orange-400 to-yellow-400 h-2 rounded-full" style={{ width: '23%' }}></div>
                </div>
              </div>
            </div>
          </div>
